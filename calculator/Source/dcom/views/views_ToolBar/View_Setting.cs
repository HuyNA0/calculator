...
namespace dcom.views.views_ToolBar
{
    public partial class View_Setting : UserControl
    {
        ...
        public void LoadData()
        {
            ...
            textBox_CoresiPath.Text = DatabaseVariables.CoresiPath;
        ...
        private void panel_CoresiPathBrowse_Click(object sender, EventArgs e)
        {
            textBox_CoresiPath.Text = Controller_UIHandling.GetFileDialogPath(textBox_CoresiPath.Text);
        }
        ...
        private void textBox_CoresiPath_TextChanged(object sender, EventArgs e)
        {
            DatabaseVariables.CoresiPath = textBox_CoresiPath.Text;
        }
